...
function get_git_status()
    local file = io.popen("git --no-optional-locks status --porcelain | %GIT_INSTALL_ROOT%\\usr\\bin\\cut -c-2 | %GIT_INSTALL_ROOT%\\usr\\bin\\sort | %GIT_INSTALL_ROOT%\\usr\\bin\\uniq -c 2>nul")
